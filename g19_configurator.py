...
class ClockTabWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.cmb_date_fmt = QComboBox(); self.cmb_date_fmt.addItems(["%A, %d %B", "%A, %B %d", "%A, %d %b", "%A, %b %d", "%a, %d %b", "%a, %b %d", "%a, %d %B", "%a, %B %d", "%Y-%m-%d", "%d/%m/%Y"])
...
class G19Configurator(QWidget):
    ...
    def _get_default_config(self):
        ...
        return {
            ...
            "profiles": [
                {"name": "Profile 1", "description": "Default", "m_led_mask": 128, "backlight_color": [255, 50, 50], "backlight_brightness": 100, "profile_screen_index": 0, "g_key_map": {}},
                {"name": "Profile 2", "description": "", "m_led_mask": 64, "backlight_color": [50, 255, 50], "backlight_brightness": 100, "profile_screen_index": 0, "g_key_map": {}},
                {"name": "Profile 3", "description": "", "m_led_mask": 32, "backlight_color": [50, 50, 255], "backlight_brightness": 100, "profile_screen_index": 0, "g_key_map": {}}
            ],
            "screens": {
    ...
    def load_config_to_ui(self, force_reload_file=True):
        ...
        self.cmb_hw_date_fmt = QComboBox(); self.cmb_hw_date_fmt.addItems(["%A, %d %B", "%A, %B %d", "%A, %d %b", "%A, %b %d", "%a, %d %b", "%a, %b %d", "%a, %d %B", "%a, %B %d", "%Y-%m-%d", "%d/%m/%Y"])
